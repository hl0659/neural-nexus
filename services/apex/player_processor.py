"""
Neural Nexus v3.0 - APEX Player Processor
...
class PlayerProcessor:
    """Processes match participants and extracts player information"""
...
if __name__ == "__main__":
    ...
    print("Testing Player Processor...")
    print("="*60)
    
    db_pool.initialize()
    
    # Get a few matches from database
    ...
    # Get 3 matches that don't have participants yet
    cur.execute("""
    ...
    if not matches_to_process:
        print("❌ No matches without participants found. Run collector first!")
        db_pool.close()
        exit(1)
    ...
    for match_id, region in matches_to_process:
        ...
        # Load match data
        match_data = json_handler.load_match(match_id, region, 'apex')
    ...
    print(f"  APEX queue: {get_queue_depth('apex')}")
    ...
    print("\n✅ Player processor test complete!")